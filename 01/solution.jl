...
# Subtleties:
# * if distance > 100 we can have guranteed many wraps around => count dith div
# * if distance < 100: rightward passes 0 if new_pos >100 & leftward if new_pos < 0
# * if left turn starting at 0 there is no click => don't count
